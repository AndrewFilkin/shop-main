                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>{{$products->brand}}</strong></p>
                                </li>
                            </ul>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>{{$products->color}}</strong></p>
                                </li>
                            </ul>
                            <form action="{{route('save.product.to.basket')}}" method="POST">
                                @csrf
                                <input type="hidden" name="name" value="{{$products->name}}">
                                <input type="hidden" name="price" value="{{$products->price}}">
                                <input type="hidden" name="product" value="{{$products->brand}}">
                                        ...
                                        <ul class="list-inline pb-3">
                                            ...
                                            @foreach($sizes as $size)
                                                <li class="list-inline-item"><span
                                                        class="btn btn-success btn-size">{{$size}}</span></li>
                                            @endforeach
                                        </ul>
                                    </div>
                                    <div class="col-auto">
