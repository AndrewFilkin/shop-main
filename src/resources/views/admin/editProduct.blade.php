                    ...
                    <div class="card mb-3">
                        @if(isset($images[0]->image))
                            <img class="card-img img-fluid"
                                 src="{{ URL::asset("assets/img/product_images/{$images[0]->image}") }}"
                                 alt="Card image cap" id="product-detail">
                        @else
                            <img class="card-img img-fluid"
                                 src="{{ URL::asset('assets/img/product_images/notfound.jpg') }}" alt="Card image cap"
                                 id="product-detail">
                        @endif
                    </div>
                    <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.update.product', $products->id) }}"
                            ">
                            @csrf
                            @method('PUT')
                            <input type="text" class="form-control mt-1" id="name" name="name"
                                   value="{{$products->name}}">
                            <p class="h3 py-2"><input type="text" class="form-control mt-1" id="price" name="price"
                                                      value="{{$products->price}}"></p>
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong><input type="text" class="form-control mt-1"
                                                                         id="brand" name="brand"
                                                                         value="{{$products->brand}}"></strong></p>
                                </li>
                            </ul>

                            <h6>Description:</h6>
                            <p><textarea class="form-control mt-1" id="description" name="description"
                                         rows="8">{{$products->description}}</textarea></p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    ...
                                    <div class="form-check form-switch">
                                        ...
                                        @if ($products->active == 1)
                                            ...
                                            <input class="form-check-input" type="checkbox" name="active" value="1"
                                                   {{ old('agreement') == '1' ? 'checked' : '0' }} checked>
                                        @else
                                            <input class="form-check-input" type="checkbox" name="active" value="1"
                                                {{ old('agreement') == '1' ? 'checked' : '0' }}>
                                        @endif

                                        <label class="form-check-label" for="flexSwitchCheckChecked">Disable/Enable
                                            product</label>
                                    </div>
                                    </li>
                                </ul>
