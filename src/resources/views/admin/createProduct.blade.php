                                            ...
                                            @for($i = 1; $i < count($images); $i++)
                                                <div class="col-4">
                                                    <a href="#">
                                                        ...
                                                        {{--                                                             src='{{ URL::asset("assets/img/product_images/{$images[$i]->image}") }}'--}}
                                                        {{--                                                             alt="Product Image 1">--}}
                                                    </a>
                                                </div>
                                            @endfor
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{route('admin.product.create')}}"
                                ...
                                @csrf
                                <p class="h3 py-2"><select class="form-select" aria-label="Default select example"
                                                           name="category">
                                ...
                                <p class="h3 py-2">Name: <input type="text" class="form-control mt-1" id="name"
                                                                name="name"></p>
                                <p class="h3 py-2">Type(Куртка, рубашка и т.д.): <input type="text" class="form-control mt-1" id="type"
                                                                name="type"></p>
                                <p class="h3 py-2">Price: <input type="text" class="form-control mt-1" id="price"
                                                                 name="price"></p>
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <p class="text-muted"><strong><input type="text" class="form-control mt-1"
                                                                             id="brand" name="brand"></strong></p>
                                    </li>
                                </ul>

                                <h6>Description:</h6>
                                <p><textarea class="form-control mt-1" id="description" name="description"
                                             rows="8"></textarea></p>
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                    ...
                                    <li class="list-inline">
                                        <input type="text" class="form-control mt-1" id="color" name="color">
                                    </li>
                                </ul>
                                    ...
                                    <div class="col-auto">
                                        <ul class="list-inline pb-3">
                                            <li class="list-inline-item">Size :
                                                <input type="text" class="form-control mt-1" id="size" name="size">
                                            </li>
                                            <br>
                                            <br>
                                            <li class="list-inline-item">Main image :
                                                <input type="file" class="form-control mt-1" id="splash_screen_image"
                                                       name="splash_screen_image">
                                            </li>
                                            <br>
                                            <br>
                                            <li class="list-inline-item">Product images :
                                                <input type="file" class="form-control mt-1" id="product_images"
        ...
        <div class="container">
            ...
            <div id="carousel-related-product">
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('assets/img/shop_08.jpg') }}">
                            <div
                                class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white" href="shop-single.html"><i
                                                class="far fa-heart"></i></a></li>
                                    <li><a class="btn btn-success texproduct_image_3.jpgt-white mt-2"
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('assets/img/shop_09.jpg') }}">
                            <div
                                class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white" href="shop-single.html"><i
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('assets/img/shop_10.jpg') }}">
                            <div
                                class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white" href="shop-single.html"><i
                ...
                <div class="p-2 pb-3">
                    <div class="product-wap card rounded-0">
                        <div class="card rounded-0">
                            <img class="card-img rounded-0 img-fluid" src="{{ URL::asset('assets/img/shop_11.jpg') }}">
                            <div
                                class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white" href="shop-single.html"><i
                            ...
                            <div
                                ...
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-success text-white"
                                           href="{{ URL::asset('shop-single.html') }}"><i class="far fa-heart"></i></a>
                                    </li>
                                    <li><a class="btn btn-success text-white mt-2"
                                           href="{{ URL::asset('shop-single.html') }}"><i class="far fa-eye"></i></a>
                                    </li>
                                    <li><a class="btn btn-success text-white mt-2"
                                           href="{{ URL::asset('shop-single.html') }}"><i class="fas fa-cart-plus"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="{{ URL::asset('shop-single.html') }}" class="h3 text-decoration-none">Oupidatat
                                non</a>
                            <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                <li>M/L/X/XL</li>
                                <li class="pt-2">
